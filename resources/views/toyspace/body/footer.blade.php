  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 footer-links contact">
        <h4>Contact Us</h4>
        <ul>
          <li><i class="bi bi-telephone"></i> <a href="#" style="margin-left: 8px;">+6281-2345-6789</a></li>
          <li><i class="bi bi-envelope"></i> <a href="#" style="margin-left: 8px;">toyspaceinc@gmail.com</a>
          </li>
          <li><i class="bi bi-geo-alt"></i> <a href="#" style="margin-left: 8px;">Surabaya, Jawa Timur</a></li>
        </ul>
...
<div class="container footer-bottom clearfix">
  <div class="copyright">Copyright 
    &copy; 2023 <a href="">Toyspace.Inc.</a> - Powered by JasterWeb
  </div>
</div>
</footer><!-- End Footer -->